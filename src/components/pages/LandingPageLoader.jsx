...
const LandingPageLoader = ({ loading }) => {
	...
	const logoData = [
		{ fill: "#3F4F69", class: "w-6 h-6", path: "opacity-60", delay: 1.2, duration: .3, },
		{ fill: "#7B8CA6", class: "w-8 h-8", path: "opacity-75", delay: 1, duration: .3, },
		{ fill: "#D4494C", class: "w-12 h-12", path: "opacity-100", delay: .5, duration: .3, },
		{ fill: "#7B8CA6", class: "w-8 h-8", path: "opacity-75", delay: .8, duration: .3, },
		{ fill: "#3F4F69", class: "w-6 h-6", path: "opacity-60", delay: 1.2, duration: .3, },
	]
		...
		<AnimatePresence>
			{loading && (
				<motion.div
					variants={zoomIn(0, 1)}
					exit="hidden"
					className="grid place-items-center absolute top-0 left-0 right-0 w-full h-screen scrollbar-hide"
